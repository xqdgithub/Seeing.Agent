...
";
        ...
        [Fact]
        public void BuildToolSection_WithObjectLevelRequiredArray_DoesNotThrow_AndMarksRequired()
        {
            // 标准 JSON Schema：required 在 object 级为字符串数组（BuiltInToolBase / 真实工具）
            var parametersJson = @"{
                ""type"": ""object"",
                ""properties"": {
                    ""path"": {
            ...
            var act = () => _builder.BuildToolSection(tools);
        ...
        [Fact]
        public void ToolsPromptSectionContributor_WithRequiredArrayAndUnionType_DoesNotThrow()
        {
            var parametersJson = @"{
                ""type"": ""object"",
                ""properties"": {
