...
public class CompressionResult
{
    ...
    /// <summary>
    /// Gets or sets the compressed messages.
    /// </summary>
    public IReadOnlyList<SessionMessage> CompressedMessages { get; set; } = Array.Empty<SessionMessage>();
    ...
    public static CompressionResult Succeeded(
        ...
        int tokensAfter, 
        int messagesRemoved,
        IReadOnlyList<SessionMessage> compressedMessages) => new()
    {
        Success = true,
