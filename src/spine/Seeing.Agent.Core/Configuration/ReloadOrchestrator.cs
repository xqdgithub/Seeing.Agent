...
public sealed class ReloadOrchestrator : IReloadSignalBus, IReloadHandlerRegistry, IDisposable
{
    ...
    private readonly Seeing.Agent.Core.Modules.ModuleReloadOptions? _moduleReloadOptions;
    ...
    /// <summary>
    /// 模块 Deactivate 在途策略（与 <see cref="Seeing.Agent.Core.Modules.ModuleReloadOptions.ForceCancelInFlight"/> 同步）。
    ...
    public ReloadOrchestrator(
        ...
        Seeing.Agent.Core.Modules.ModuleReloadOptions? moduleReloadOptions = null)
    {
        _logger = logger;
