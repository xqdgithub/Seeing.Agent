...
public interface IUiContribution
{
    ...
    /// <summary>
    /// 返回本模块的 UI 贡献列表。
    /// 元素类型为 <see cref="NavContribution"/>、<see cref="RouteContribution"/>、
    /// <see cref="SettingsCardContribution"/>、<see cref="SlotContribution"/>
    /// 或 <see cref="MessageRendererContribution"/>。
    /// </summary>
